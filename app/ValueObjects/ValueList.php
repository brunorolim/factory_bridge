...
class ValueList
{
    ...
    {
        return ( $emptyOption ? [ '' => '-' ] : [ ] ) + (new static)->_some;
    }
     ...
     * @return array
     */
    public static function listOfKeysAndValues()
    {
    ...
    /**
     * Retorna o nome formatado referente ao valor informado no formato de string tratadas,
     * para auxiliar na distinção de tipos.
     * Se o valor não for encontrado, retorna null.
     *
     * @param string $key
     *
    ...
    public static function getString($key)
    {
        ...
        return ( isset( $instance->_toString[$key] ) ? $instance->_toString[$key] : null );
    }
     ...
     * @return array
     */
    public static function listForDropdown2($emptyOption = false)
    {
